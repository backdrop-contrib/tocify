...
**Note:** Backdrop also has a separate contributed module named [Tocbot](https://github.com/backdrop-contrib/tocbot), which uses the same underlying JS library. Tocify differs in that it was written from the ground up specifically for Backdrop and does not include any legacy Drupal code. 
